				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
							<li><a href="location.php"><button style="color: black">BOOK A RIDE</button></a></li>
								...
								<!-- <li><a href="#services"><i class="fa fa-gears">Services</i></a></li> -->
			...
			<div class="contact-agileinfo">
				...
				<div class="col-md-4 contact-right wthree">
					<div class="contact-text w3-agileits">
						<h4>GET IN TOUCH :</h4>
						<p><i class="fa fa-map-marker"></i> #675 Allen Avenue Ikeja Lagos </p>
						<p><i class="fa fa-phone"></i> Telephone : +234567890101</p>
						<p><i class="fa fa-envelope-o"></i> Email : <a href="mailto:info@commute.ng">info@commute.ng</a></p> 
					</div> 
				</div> 
				<div class="clearfix"> </div>	
			</div>
