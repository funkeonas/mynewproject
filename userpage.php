			...
			<div class="top-nav w3-agiletop">
				<div class="container">
					<div class="navbar-header w3llogo">
						...
						<h1><a href="userpage.php"><img src="images/commute.jpg" width="200px" height="auto"></a></h1> 
					</div>
							...
							<ul class="nav navbar">
								 ...
								 <li class="dropdown">
                                     ...
                                     <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">Get Ride Coupons</a></li> 
                                    </ul>
                                 </li>
                                
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">Welcome <?php['user']?><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
